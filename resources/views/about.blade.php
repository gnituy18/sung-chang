...
@section('content')
  ...
  <div style="min-height:350px;">
    ...
    <div style="display:inline-block;padding-left:10px;">
      <img style="display:inline-block;margin:15px 5px;vertical-align:top;" src="/storage/brand-wood.png" height="220">
      <img style="display:inline-block;margin:15px 5px;vertical-align:top;" src="/storage/company.jpg" height="220">
    </div>
  </div>
@endsection
